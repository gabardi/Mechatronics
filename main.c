...
Project : Lab 3
Date    : 9/18/2019
Author  : Ryan Quinn & Kaitlyn Gabardi
Class   : ME 445 
...
/******************************* ~Lab03~ ***************************************** 
The purpose of this lab is to get hands-on experience using CodeVisionAVR,
AVRStudio, and the JTAG-ICE 3. This program demonstrates how to define variables,
casting, and basic C-programming that will be used the remainder of the semester. 

CodeWizardAVR was used to create a project framework for the ATmega2560 with a
...
// Declare your local variables here
    unsigned char a;                        //8 bits in length
    unsigned char b;                        //8 bits in length
    unsigned int c;                         //16 bits in length
    unsigned int d;                         //16 bits in length
    signed int e;                           //16 bits in length
    signed int f;                           //16 bits in length
    unsigned int result;                    //16 bits in length
    unsigned long int long_unsigned_result; //32 bits in length
    signed long int long_signed_result;     //32 bits in length
    float pi = 3.14159;                     //32 bits in length
    float result_fp;                        //32 bits in length
...
while (1)
      {
   //Part 6
   //  a++; //a breakpoint was used to iterate 6 times
   ...
   b = 220;             //Part 9 & 10
   result = a + b;      //Part 9
   result = (int)a + b; //Part 10
   
   c = 65000;           //Part 11 & 12
   d = 555;             //Part 11 & 12
   long_unsigned_result = c + d;                    //Part 11
   long_unsigned_result = (unsigned long int)c + d; //Part 12
   
   e = 65000;           //Part 13 & 14 & 16
   f = 555;             //Part 13 & 14 & 16
   
   long_signed_result = e + f;                                  //Part 13
   
   long_signed_result = (unsigned int)e + (unsigned long int)f; //Part 14
   
   long_signed_result = (unsigned long int)e * f;               //Part 16
  
   long_signed_result = (unsigned int)e * (unsigned long int)f; //Part 16
   
   long_signed_result = (unsigned long int)e * pi;              //Part 17
