...
Lab 4 Goals:
The purpose of this lab is to learn how to write functions,
read input and output pins, and write a program to actuate
the solenoid made from Lab 2.
*******************************************************/

#include <io.h>        // looks in compilers folder 
#include <logic8bit.h> // quotations mean to look in the local directory of the project first

// Declare your global variables here
char variable1;
char variable2;
char q11_test;  // Test value for Part 11
char q12_test;  // Test value for Part 12
char swA;       // Switch A value
char swB;       // Switch B value
char inter_1;
char inter_2;
...
while (1)
	 ...
	 // Part 4: Reads values of PORTA input and outputs values to LED bank 
	 //PORTB = PINA; 
	  
	 //Part 5: Modify code so that all LEDs would remain on by default
	 //PORTB = ~PINA;
	 
	 // Part 11: Testing or_8bit code
	 //variable1 = 0x00;
	 //variable2 = 0x00;
	 //q11_test = or_8bit(variable1,variable2); //verified output returned 0x00    
	 
	 //variable1 = 0xFF;
	 //variable2 = 0xFF;
	 //q11_test = or_8bit(variable1,variable2); //verified output returned 0xFF    
	 
	 //variable1 = 0x44;
	 //variable2 = 0xAA;
	 //q11_test = or_8bit(variable1,variable2); //verified output returned 0xEE    
	 
	 // Part 12: Testing and_8bit code
	 //variable1 = 0xFF;
	 //variable2 = 0xFF;
	 //q12_test = and_8bit(variable1,variable2); //verified output returned 0xFF  
	 
	 //variable1 = 0x00;
	 //variable2 = 0xFF;
	 //q12_test = and_8bit(variable1,variable2); //verified output returned 0x00
	 
	 //variable1 = 0xAA;
	 //variable2 = 0xFF;
	 //q12_test = and_8bit(variable1,variable2); //verified output returned 0xAA 
	 
	 // Part 12: Testing xor_8bit code
     //variable1 = 0xFF;
	 //variable2 = 0xFF;
	 //q12_test = xor_8bit(variable1,variable2); //verified output returned 0x00  
	 
	 //variable1 = 0x00;
	 //variable2 = 0xFF;
	 //q12_test = xor_8bit(variable1,variable2); //verified output returned 0xFF
	 
	 //variable1 = 0xCA;
	 //variable2 = 0xFF;
	 //q12_test = xor_8bit(variable1,variable2); //verified output returned 0x35 
     
	 // Part 13
	 /* Takes current state of PINA, which is configured as an input, and uses 
	 the "or" function in order to output 0b10111111 to ensure bit 6 is set to zero. 
	 Then the bits are inverted to give an output of 0b01000000. Finally a shift of 
	 6*/
	 
	 swA = (~or_8bit(0b10111111,PINA))>>6; 
	 
	  /* Takes current state of PINA, which is configured as an input, and uses 
	 the "or" function in order ensure bit 7 is set to zero. 
	 Then the bits are inverted to give an output of 0b10000000. Finally a shift of 
	 7 to the right is used. "And" function is used to mask input bit 7*/
	 swB = (~or_8bit(0b01111111,PINA))>>7; // currently all 0x00/0xFF
	 swB = and_8bit(0b00000001,swB); //masks input bit 7
	 
	 // Part 15	
	inter_1 = and_8bit(swA,swB)<<6;       //0b00000001 left shift by 6 results to 0b01000000, then mask input bit 6 
	inter_2 = and_8bit(PORTB,0b10111111); //masks input bit 7
	PORTB = or_8bit(inter_1,inter_2);     //Included "or" statement to set PORTB output bit 6 to logic 1 (given a solenoid is active high).
